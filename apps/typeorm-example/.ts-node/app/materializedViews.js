...
exports.OrderFactEnrichedView = exports.OrderFactEnriched = exports.dictOrders = exports.dictProducts = exports.dictCustomers = void 0;
...
exports.OrderFactEnriched = new moose_lib_1.OlapTable('order_fact_enriched', {
...
exports.OrderFactEnrichedView = new moose_lib_1.MaterializedView({
    ...
    SELECT
    ${exports.OrderFactEnriched.columns.id},
    ${sinkTables_1.OrderItemTable.columns.orderId},
    ${sinkTables_1.OrderItemTable.columns.productId},
    ${sinkTables_1.OrderItemTable.columns.quantity},
    ...
    targetTable: exports.OrderFactEnriched,
}, {
    version: "3.1",
    components: {
        schemas: {
