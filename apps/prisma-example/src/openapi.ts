/**
 * OpenAPI 3.1.0 Specification for Prisma API
 */

export const openApiSpec = {
  openapi: '3.1.0',
  info: {
    title: 'Prisma OLTP API',
    version: '1.0.0',
    description: 'A RESTful API for managing customers, products, orders, and order items using Prisma',
    contact: {
      name: 'API Support',
    },
  },
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    service: { type: 'string', example: 'Prisma API Server' },
