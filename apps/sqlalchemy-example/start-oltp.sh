...
for i in {1..30}; do
  if docker exec sqlalchemy-oltp-postgres pg_isready -U postgres > /dev/null 2>&1; then
...
echo "Database: sqlalchemy_db"
echo "User: postgres"
echo "Password: postgres"
echo ""
echo "Next steps:"
echo "  1. Start the FastAPI server: python -m uvicorn src.main:app --reload --port 3002"
